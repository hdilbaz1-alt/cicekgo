...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    NOTIF_VAPID: '/api/Notifications/vapid-public-key',
    NOTIF_SUBSCRIBE: '/api/Notifications/subscribe',
    ...
    EMAIL_TEMPLATE_PREVIEW: '/api/Email/templates/preview',
    EMAIL_MERGE_TAGS: '/api/Email/merge-tags',
    EMAIL_TRIGGERS: '/api/Email/triggers',
