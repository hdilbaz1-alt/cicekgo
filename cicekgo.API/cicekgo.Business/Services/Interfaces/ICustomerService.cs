...
namespace cicekgo.Business.Services.Interfaces
{
    ...
    {
        Task<int> AddAsync(CustomerAddDto dto, string createdUser, CancellationToken ct = default);
    ...
    string? search, int page, int pageSize, CancellationToken ct = default);
        ...
        Task<int> AddCustomerPaymentAsync(CustomerPaymentDto dto, string createdBy, CancellationToken ct = default);
